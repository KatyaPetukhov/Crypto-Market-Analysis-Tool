      ...
      <table className="table mx-auto md:px-6 py-8">
        <thead>
          <tr className="text-left">
            ...
            <th className="p-2 hidden md:table-cell">Balance USD</th>
            <th className="p-2 hidden md:table-cell">Profit</th>
          </tr>
        </thead>
        <tbody key={"TableBody"}>
          {props.Wallet.data.map((row, index) => {
            ...
            return (
              <tr key={key} className="text-left">
                ...
                <td className="w-auto p-2 align-top border-b border-gray-200 hidden md:table-cell">
                  {row[1]}
                </td>
